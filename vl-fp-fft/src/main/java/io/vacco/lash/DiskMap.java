...
import io.vacco.lash.serde.Serde;
...
public class DiskMap<K, V> implements ConcurrentMap<K, V>, Closeable {
  ...
  public boolean equals(Object obj) {
    ...
    final Iterator<Entry<K, V>> it = asM.entrySet().iterator();
    try {
      while (it.hasNext()) {
  ...
  protected class ValCollection extends AbstractCollection<V> {
    ...
    public Iterator<V> iterator() {
      return new Iterator<V>() {
        final Iterator<Entry<K, V>> backingIt = DiskMap.this.entrySet().iterator();
  ...
  protected class EntrySet extends AbstractSet<Entry<K, V>> {
    ...
    public Iterator<Entry<K, V>> iterator() {
      return new Iterator<Entry<K, V>>() {
        final Iterator<Entry<byte[], byte[]>> backingIt = backingMap.iterator();
        ...
        public Entry<K, V> next() {
          final Entry<byte[], byte[]> e = backingIt.next();
