...
public class VlAnchorTrainingSupplier implements JtPredictionSampleSupplier {
  ...
  public VlAnchorTrainingSupplier(ObjectMapper m) throws Exception {
    VlTrainingDataSet dataSet = m.readValue(new File("./peak-training/peaks.json"), VlTrainingDataSet.class);
